    ...
    if (list) {
        ...
        for (size_t i=0 ; i<list->numHwLayers ; i++) {
            ...
            if (isSkipLayer(&list->hwLayers[i])) {
                ...
                correct_crop_rects(hwcModule->fbDevice, list->hwLayers[i].sourceCrop,
